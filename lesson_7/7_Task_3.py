#TODO - 3. Реализовать программу работы с органическими клетками.
...
class Cell:
    ...
    def __sub__(self, other):
        if int(self.cnt_cell - other.cnt_cell) >= 0:
            return Cell(self.cnt_cell - other.cnt_cell)
        else:
            return 'Получено отрицательное значение'
    ...
    def __str__(self):
        return f'Результат: {self.cnt_cell}'

    def make_order(self, cnt_row):
        str1 = ''
        for i in range(1, self.cnt_cell + 1):
            str1 += '*'
            if i % cnt_row == 0:
                str1 += '\n'
        return str1
